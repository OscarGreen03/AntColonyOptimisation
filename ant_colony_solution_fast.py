...
def BPP(bin_count, items, iterations, p, e):
    colony = AntColony()
    ...
    for i in range(iterations):
        ...
        for path in paths:
            ...
            if fitness < best_fitness:
                ...
                best_path = path
                print(f"New best solution {i} found with fitness: {fitness}")
...
for test in tests:
    ...
    best_path, best_fitness = BPP(10, items_list2, 10000, test[0], test[1])
